...
"""
start_yr = 2018 # give starting year from which you want to download/convert data: 1901 ownwards for rainfall, 1951 for tmax and tmin
end_yr = 2018 # give ending year upto which you want to download/convert data
...
file_dir = '/' # this path should be same as mentioned in previous line
...
for yr in range(0,years_no):
    f = open("/results"+str(start_yr+yr)+"_"+str(variable)+".csv",'w') # just change the path where you want to save csv file
